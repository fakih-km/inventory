...
if(isset($_POST['btnSimpan'])){
	...
	//mengisi tabel
		$mysql ="INSERT INTO barang (kd_barang, nm_barang, keterangan, merek, harga, satuan, kd_kategori, files)

		VALUES ('$kodeBarang','$txtNama','$txtKeterangan','$txtMerk','$txtHarga','$cmbSatuan','$cmbKategori','$files')";
