...
<table id="datatable" class="table table-striped table-bordered">
	<thead>
		<tr>
			...
			<th><strong>Tanggal PO</strong></th>
			<th>Nama suplier</th>
			<th><strong>Divisi tujuan</strong></th>
	...
	$mySql ="SELECT a.no_po, a.tgl_po, a.divisi_tujuan, b.nm_suplier,a.tanggal, a.total FROM po a LEFT JOIN suplier b ON a.nm_supplier=b.kd_suplier
	";
	...
	<tr>
		...
		<td><?php echo $myData['divisi_tujuan']?></td>
