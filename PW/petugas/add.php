...
if(isset($_POST['btnSimpan'])){
	...
	$alamat = str_replace("'","&acute;",$alamat);//menghalangi penulisan tanda petik
	...
	$sqlCek="SELECT * FROM petugas WHERE nm_petugas='$txtNama'";
	...
	//mengisi tabel
		$mysql ="INSERT INTO petugas (kd_petugas, nm_petugas, no_telepon, username, password, level, jns_kelamin, alamat)

		VALUES ('$kodepetugas','$txtNama','$txtTelepon','$txtUsername',md5('$txtPass'),'$cmbLevel','$cmbJns','$alamat')";
...
<form id="theform" data-parslay-validate class="form-horizontal form-label-left" 
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
		<input type="text" id="alamat"   class="form-control col-md-7 col-xs-12" name="txtAlamat" data-parslay-error-message="field ini harus di isi" value="<?php echo $dataHarga;?>">
	</div>
</div>
